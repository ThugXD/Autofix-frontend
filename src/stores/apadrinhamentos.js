...
const mockApadrinhamentos = [
  {
    ...
    padrinhoNome: 'Sofia Madrinha',
    padrinhoEmail: 'sofia.madrinha@gmail.com',
    padrinhoTelefone: '+258 84 100 0009',
...
export const useApadrinhamentosStore = defineStore('apadrinhamentos', () => {
  ...
  const getHistoricoPadrinho = (padrinhoId) =>
    computed(() => lista.value.filter(a => a.padrinhoId === padrinhoId))
